...
OPTIONS : 
	  ...
	  3-DIO_UINT8_OUTPUT_LOW
	  4-DIO_UINT8_OUTPUT_HIGH	
*/

#define DIO__UINT8_PA0_INITIAL_VALUE              DIO_UINT8_OUTPUT_LOW
#define DIO__UINT8_PA1_INITIAL_VALUE              DIO_UINT8_OUTPUT_LOW
#define DIO__UINT8_PA2_INITIAL_VALUE              DIO_UINT8_OUTPUT_LOW
...
#define DIO__UINT8_PC4_INITIAL_VALUE              DIO_UINT8_OUTPUT_HIGH
#define DIO__UINT8_PC5_INITIAL_VALUE              DIO_UINT8_OUTPUT_HIGH
#define DIO__UINT8_PC6_INITIAL_VALUE              DIO_UINT8_OUTPUT_HIGH
#define DIO__UINT8_PC7_INITIAL_VALUE              DIO_UINT8_OUTPUT_HIGH

#define DIO__UINT8_PD0_INITIAL_VALUE             DIO_UINT8_OUTPUT_LOW
#define DIO__UINT8_PD1_INITIAL_VALUE             DIO_UINT8_OUTPUT_LOW
#define DIO__UINT8_PD2_INITIAL_VALUE             DIO_UINT8_OUTPUT_LOW
#define DIO__UINT8_PD3_INITIAL_VALUE             DIO_UINT8_OUTPUT_LOW
#define DIO__UINT8_PD4_INITIAL_VALUE             DIO_UINT8_OUTPUT_LOW
#define DIO__UINT8_PD5_INITIAL_VALUE             DIO_UINT8_OUTPUT_LOW
#define DIO__UINT8_PD6_INITIAL_VALUE             DIO_UINT8_OUTPUT_LOW
#define DIO__UINT8_PD7_INITIAL_VALUE             DIO_UINT8_OUTPUT_LOW
