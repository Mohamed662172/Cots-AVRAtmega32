...
#define LCD__UINT8_CG_RAMLOCATION8 8

_uint8  LCD_A_UINT8CHAR1[8]=LCD_ARRAY_UINT8_SPECIAL_CHAR1_VALUE;
_uint8  LCD_A_UINT8CHAR2[8]=LCD_ARRAY_UINT8_SPECIAL_CHAR2_VALUE;
_uint8  LCD_A_UINT8CHAR3[8]=LCD_ARRAY_UINT8_SPECIAL_CHAR3_VALUE;
_uint8  LCD_A_UINT8CHAR4[8]=LCD_ARRAY_UINT8_SPECIAL_CHAR4_VALUE;
_uint8  LCD_A_UINT8CHAR5[8]=LCD_ARRAY_UINT8_SPECIAL_CHAR5_VALUE;
_uint8  LCD_A_UINT8CHAR6[8]=LCD_ARRAY_UINT8_SPECIAL_CHAR6_VALUE;
_uint8  LCD_A_UINT8CHAR7[8]=LCD_ARRAY_UINT8_SPECIAL_CHAR7_VALUE;
_uint8  LCD_A_UINT8CHAR8[8]=LCD_ARRAY_UINT8_SPECIAL_CHAR8_VALUE;

_uint8 *LCD_A_UINT8SPECIALCHAR[9]={LCD_A_UINT8CHAR1,
								   LCD_A_UINT8CHAR2,
								   LCD_A_UINT8CHAR3,
								   LCD_A_UINT8CHAR4,
								   LCD_A_UINT8CHAR5,
...
{
    CheckStatus Local_CheckStausReturnValue = CHECK_SUCCESS;
    if(LCD__UINT8_SHIFT_ACTIVATE==1 || LCD__UINT8_SHIFT_ACTIVATE==0 || LCD__UINT8_SHIFT_ACTIVATE==2)
    {
       ...
       else if(LCD__UINT8_SHIFT_ACTIVATE == 2)
       {
